...
function markdownToDraft(string) {
  ...
  var remarkableOptions =
    _typeof(options.remarkableOptions) === "object"
  ...
  if (remarkableOptions && remarkableOptions.disable) {
    for (
      var _i = 0, _Object$entries = Object.entries(remarkableOptions.disable);
  ...
  if (remarkableOptions && remarkableOptions.enable) {
    for (
      var _i2 = 0, _Object$entries2 = Object.entries(remarkableOptions.enable);
  ...
  var BlockTypes = Object.assign(
    {},
    DefaultBlockTypes,
    options.blockTypes || {}
  );
  var BlockEntities = Object.assign(
    {},
